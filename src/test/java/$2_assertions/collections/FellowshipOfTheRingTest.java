...
import fellowshipofthering.Fellowship;
...
public class FellowshipOfTheRingTest {
    ...
    // assert-j zawiera asercje specyficzne dla kolekcji i jeszcze bardziej specyficzne dla list
    @Ignore
    @Test
    public void races_in_fellowship() {
        // dla jednego elfa mamy to samo co w poprzednim teście
        assertThat(fellows.elves()).hasSize(1).contains(Legolas());
        ...
        // TODO: dodaj jeszcze kilka asercji poznając API assert-j
    }
    ...
    public void fellows_have_names() {
        ...
        // TODO: Skróć poniższe asercje do jednej linii. Pdpowiedź: użyj assertThat(fellows).extracting(...)
